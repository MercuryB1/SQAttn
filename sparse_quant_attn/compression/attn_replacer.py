...
def delayed_sdpa_wrapper_with_attn_weights(layer_idx, bit8_window_sizes=0, bit4_window_sizes=0, sink_window_size=0, args=None):
    # Determine if we should use per-head mask based on input types
    ...
    def attention_fn(
        ...
        # import pdb; pdb.set_trace()
        attn_weights = cal_attn_weight(module, q, k)
