...
def main():
    ...
    parser.add_argument("--bit8_thres", type=float, default=0.95, help="threshold for bit8")
    parser.add_argument("--bit4_thres", type=float, default=0.98, help="threshold for bit4")
    ...
    parser.add_argument("--use_relative_distance", action="store_true", help="use relative window")
